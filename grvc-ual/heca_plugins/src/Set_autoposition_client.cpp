...
{
  ros::init(argc, argv, "Set_autoposition_client");
  ROS_INFO("argc:%d\n",argc);
  if (argc != 1)
  {
    ROS_INFO("Error, too much arguments");
    return 1;
  }

  ros::NodeHandle n;
  ros::ServiceClient client = n.serviceClient<heca_plugins::Set_position>("Set_autoposition");
  heca_plugins::Set_position srv;
